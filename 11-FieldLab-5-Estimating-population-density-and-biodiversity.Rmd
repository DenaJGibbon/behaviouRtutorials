...
```{r, echo=FALSE, out.height="50%", out.width = "50%",fig.align='center',fig.cap='Biodiversity image; Justin / CC BY-SA (https://creativecommons.org/licenses/by-sa/3.0)'}
knitr::include_graphics("images/behaviouR_figures/biodiversity.png")
```
